...
def getaccess():
    data={'grant_type':'authorization_code','code':'0da26e566f06fe8b29d5704bf8b5c3ef','client_id':'MqTM8icss9Th4pZEdMDmDPeRPti90tzK','client_secret':'MCgkTbwnG80LmLH7qGdHdNEc9cQvuQaZ','redirect_uri':'http://4v5k8a.natappfree.cc/api/01/'}
    url='https://openapi.baidu.com/oauth/2.0/token'
    response=requests.post(url,data=data)
    print(response.text)
