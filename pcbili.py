...
def make_page():
    for p in range(1,2):
        ...
        url='https://webfs.tx.kugou.com/202210122201/6ced99ff1321a3375dae314d5915f01c/v2/1f890dd699cf30cf59fc7ca1a051d32d/G186/M06/1E/13/WocBAF5QSOiAOETqACv68qW1mRY607.mp3'
        urlList.append(url)
